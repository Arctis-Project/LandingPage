    ...
    <footer className="py-16 px-6">
      <div ref={ref} className={cn("max-w-5xl mx-auto flex flex-col items-center gap-8", inView ? "animate-fade-up" : "opacity-0")}>
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/Arctis-Project" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full border border-[var(--border-c)] text-[var(--text-sec)] hover:text-[var(--text)] hover:bg-[var(--md-surface-container-high)] transition-all">
